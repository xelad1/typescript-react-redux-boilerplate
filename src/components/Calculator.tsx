    ...
    return (
      <div>
        <div>
          ...
          <button className="buttonRight" onClick={ () => { this.props.actions.divide('/'); } }><div>/</div></button>
        </div>
        <div>
          ...
          <button className="buttonRight" onClick={ () => { this.props.actions.multiply('X'); } }><div>x</div></button>
        </div>
        <div>
          ...
          <button className="buttonRight" onClick={ () => { this.props.actions.subtract('-'); } }><div>-</div></button>
        </div>
        <div>
          ...
          <button className="buttonRight" onClick={ () => { this.props.actions.add('+'); } }><div>+</div></button>
        </div>
        <div>
